                    ...
                    <div class="arrow_slide three_slide-dots arrow_middle" dir="rtl">
                            ...
                            <div class="bg-light rounded box-shadow">
                                <div class="client-detail-box">
                                    <div class="pic pt-4 d-flex justify-content-around align-items-center">
                                        <img src="<?= get_stylesheet_directory_uri().'/assets/img/user-1.jpg' ?>user-1.jpg" alt="">
                        ...
                        <div class="singles_items mb-4">
                            <div class="bg-light rounded box-shadow">
                                <div class="client-detail-box">
                                    <div class="pic pt-4 d-flex justify-content-around align-items-center">
                                        <img src="<?= get_stylesheet_directory_uri().'/assets/img/user-2.jpg' ?>" alt="">
                                        <div class="reviews-comments-item-text reviews-comments-item-text-custom">
                                            <h4>الهام پاکزاد</h4>
                        ...
                        <div class="singles_items mb-4">
                            <div class="bg-light rounded box-shadow">
                                <div class="client-detail-box">
                                    <div class="pic pt-4 d-flex justify-content-around align-items-center">
                                        <img src="<?= get_stylesheet_directory_uri().'/assets/img/user-4.jpg' ?>" alt="">
                                        <div class="reviews-comments-item-text reviews-comments-item-text-custom">
                                            <h4>الهام پاکزاد</h4>
                        ...
                        <div class="singles_items mb-4">
                            <div class="bg-light rounded box-shadow">
                                <div class="client-detail-box">
                                    <div class="pic pt-4 d-flex justify-content-around align-items-center">
                                        <img src="<?= get_stylesheet_directory_uri().'/assets/img/user-5.jpg' ?>" alt="">
                                        <div class="reviews-comments-item-text reviews-comments-item-text-custom">
                                            <h4>الهام پاکزاد</h4>

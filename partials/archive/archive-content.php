        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="education_block_grid">
                    ...
                    <div class="education_block_thumb">
                        <a href="course-detail.html"><img src="<?= get_stylesheet_directory_uri().'/assets/img/course-1.jpg' ?>" class="img-fluid" alt=""></a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="education_block_grid">
                    ...
                    <div class="education_block_thumb">
                        <a href="course-detail.html"><img src="<?= get_stylesheet_directory_uri().'/assets/img/course-2.jpg' ?>" class="img-fluid" alt=""></a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="education_block_grid">
                    ...
                    <div class="education_block_thumb">
                        <a href="course-detail.html"><img src="<?= get_stylesheet_directory_uri().'/assets/img/course-3.jpg' ?>" class="img-fluid" alt=""></a>
                        <div class="topic_level bg-warning text-white">جاوااسکریپت</div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="education_block_grid">
                    ...
                    <div class="education_block_thumb">
                        <a href="course-detail.html"><img src="<?= get_stylesheet_directory_uri().'/assets/img/course-4.jpg' ?>" class="img-fluid" alt=""></a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="education_block_grid">
                    ...
                    <div class="education_block_thumb">
                        <a href="course-detail.html"><img src="<?= get_stylesheet_directory_uri().'/assets/img/course-5.jpg' ?>" class="img-fluid" alt=""></a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="education_block_grid">
                    ...
                    <div class="education_block_thumb">
                        <a href="course-detail.html"><img src="<?= get_stylesheet_directory_uri().'/assets/img/course-6.jpg' ?>" class="img-fluid" alt=""></a>

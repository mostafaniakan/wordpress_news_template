...
class HatPostTech extends WP_Widget
{
    function __construct()
    {
        parent::__construct(false, 'مطالب پر مخاطب تکنولوژی', '');
    }
...
function dwt_register_HotPost_widget_tech()
{
    register_widget('HatPostTech');
}

add_action('widgets_init', 'dwt_register_HotPost_widget_tech');